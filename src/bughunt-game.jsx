...
What is the correct loop condition?`,
  ...
  // ── Drag & drop order ───────────────────────────────────────────────────────
  {
    ...
    description: "Arrange these lines to make a correct async function that fetches and returns user data:",
    hint: "async goes on the function, await goes on the fetch.",
    blocks: [
