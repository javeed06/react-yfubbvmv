...
const QUESTIONS_CONFIG = [
  ...
  // ── Image + multiple choice ─────────────────────────────────────────────────
  {
    ...
    imageUrl: "https://placehold.co/600x200/0a0e0f/00e5ff?text=function+add(a,+b)+{%0A++return+a+-+b%3B%0A}",
  ...
  // ── Image + text answer ─────────────────────────────────────────────────────
  {
    ...
    imageUrl: "https://placehold.co/600x220/0a0e0f/00ff9d?text=Login+Flow%0A[Enter+Creds]+%E2%86%92+[Check+DB]+%E2%86%92+[Dashboard]%0AMissing+step+between+Check+DB+%26+Dashboard",
    hint: "What should happen after checking credentials before granting access?",
    expectedAnswer: ["validate token", "token validation", "verify token"],
    points: 150,
  },
